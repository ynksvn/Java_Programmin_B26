...
public class DataBaseExample {
    public static void main(String[] args) {
        ...
        List< Map<String, String> > list = new ArrayList<>(); //including previous map object
        list.add(map); // index 0 // adding values from the previous map arrayList
        list.add(makeMap("Shina", "Alhusaini", "26")); // index 1 //calling the makeMap method
        ...
        for(Map<String, String> each: list){
            if(Integer.parseInt(each.get("BATCH")) >= 20) { //parseInt to switch to integer from string
